...
class Analysis implements Impl
{
    /**
     * 保存模板页信息变量
     * @var string $_Obj
     ...
     */
    protected $_Basic_Variable = null;
    /**
     * 列表数组键命名规则
     * @var string $_Array_Key
     */
    protected $_Array_Key = null;
    /**
     * 带数组标记命名规则(增加应用标签结构)
     * @var string $_Basic_Array_Regular
     */
    protected $_Basic_Array_Regular = null;
    /**
     * 变量标记标签规则
     ...
     */
    protected $_Include_Regular = null;
    /**
     * 逻辑判断标记规则
     ...
     */
    protected $_Judge_Si = null;
    protected $_Judge_If = null;
    protected $_Judge_EF = null;
    protected $_Judge_El = null;
    protected $_Judge_Ie = null;
    /**
     * 循环执行标签规则
     ...
     */
    protected $_For_Operate = null;
    protected $_For_Begin = null;
    protected $_For_End = null;
    /**
     * foreach循环标签规则
     ...
     */
    protected $_Foreach_Operate= null;
    protected $_Foreach_Begin = null;
    protected $_Foreach_End = null;
    /**
     * 对象数据存储
            ...
            if (preg_match_all($this->_Variable, $_waiting, $_variable, PREG_SET_ORDER)) {
                ...
                if (preg_match_all($this->_For_Operate, $_operate)) {
                    ...
                    if (strpos($_operate, ' to ')) {
                        ...
                        if(is_array($_mapping[$_mapping['mapping_key']])){
