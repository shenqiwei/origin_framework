...
include("Redis/Key.php");
include("Redis/Str.php");
include("Redis/Set.php");
include("Redis/Hash.php");
include("Redis/Listing.php");
include("Redis/Sequence.php");
include("Redis/Subscription.php");
include("Redis/HLL.php");
include("Redis/Transaction.php");
